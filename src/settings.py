...
##################################
PROJECT_NAME: str = "Black Pod Rot"
PROJECT_NAME_FULL: str = "Black Pod Rot and Pod Borer on Cocoa Pod"
...
PREVIEW_IMAGE_ID: int = 4180007
# This should be filled AFTER uploading images to instance, just ID of any image.

GITHUB_URL: str = "https://github.com/dataset-ninja/black-pod-rot"
...
DOWNLOAD_ORIGINAL_URL: Optional[
    Union[str, dict]
] = "https://www.kaggle.com/datasets/kenfackbruno/black-pod-rot-and-pod-borer-on-cocoa-pod/download?datasetVersionNumber=1"
